...
if ($resultados == 0) {
  ...
  echo "<br><div class='alerta-no'>$lang[373]</div>";
                  ...
                  echo "<div class='alert alerta-no alert-dismissible'><button type='button' class='close' data-dismiss='alert'>×</button>No puedes enviar mas de 100 puntos.</div>";
...
$mensaje = "$lang[375] $_POST[cantidad] $lang[376] $username ($rango $lang[377] $nameweb)<br><center><div class=cantidad><img src=http://www.kuinz-fansite.online/images/money.png> $_POST[cantidad]</div></center>";
...
$cantidad = $puntos + $_POST['cantidad'];



$actualizar = "UPDATE usuarios SET puntos='$cantidad' WHERE username = '".$_POST['user']."' ";
