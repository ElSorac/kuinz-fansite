...
<form action="" method="post" enctype="multipart/form-data" action="../actualizar/kweet.php">
...
$enviar = "INSERT INTO eventos (autor,titulo,fecha,texto) values ('".$username."','".strip_tags($_POST['titulo'])."','".$_POST['fecha']."','".$_POST['evento']."')";
