...
$enviar = "INSERT INTO tiendadev (code_placa,precio,icono,unidades) values ('".strip_tags($_POST['code'])."','".strip_tags($_POST['precio'])."','".strip_tags($_POST['icono'])."','".strip_tags($_POST['unidades'])."')";
...
$accion = "Ha Publicado un furni en la tienda Dev";
