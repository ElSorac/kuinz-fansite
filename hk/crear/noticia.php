...
$enviar = "INSERT INTO noticias (autor,titulo,resumen,categoria,fecha,imagen,noticia) values ('".$username."','".strip_tags($_POST['titulo'])."','".strip_tags($_POST['resumen'])."','".$_POST['categoria']."','".$_POST['fecha']."','".$_POST['imagen']."','".$_POST['noticia']."')";
