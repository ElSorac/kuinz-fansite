      ...
      <div class="panel panel-default">
         ...
         <div class="panel-body">
            <table class="table table-striped">
               ...
               <tbody>
                  <?php
                     $resultado = $link->query("SELECT * FROM usuarios WHERE rank <= 7 and rank >= 3 ORDER BY rank DESC");
...
if ($_POST['rango'] && $_POST['user']) {
    ...
    }else if ($revisar1 >= 7 || $userData['rank'] >= 7 || $userData['username'] == "Krozox" || $userData['username'] == "Carlos" || $userData['username'] == "Rutierrez") {
