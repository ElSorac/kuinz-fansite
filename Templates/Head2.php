...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <head>
      ...
      <link rel="apple-touch-icon-precomposed" sizes="144x144" href="images/favicon-h.png">

      <link rel="apple-touch-icon-precomposed" sizes="114x114" href="images/favicon-h.png">

      <link rel="apple-touch-icon-precomposed" sizes="72x72" href="images/favicon-h.png">

      <link rel="apple-touch-icon-precomposed" href="images/favicon-h.png">

      <link rel="shortcut icon" href="images/favicon-h.png">

      <!-- Cierre de Favicon -->

      <!-- // Stylesheets // -->            <link href="styles/css/nav-styles.css" rel="stylesheet">
