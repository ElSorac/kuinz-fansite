...
echo "<div class='alert alerta-si alert-dismissible'><button type='button' class='close' data-dismiss='alert'>×</button>$lang[206]</div>";
	...
	<div class="panel panel-default">
            <div class="panel-heading blue">
              <h3 class="panel-title"><div class='contedor-badge'><div class='icon-news'></div></div> <?php echo $columnas['titulo']; ?></h3>
            </div>
...
<br>
     ...
     <div class="panel panel-default">
            <div class="panel-heading blue">
              <h3 class="panel-title"><div class='contedor-badge'><div class='icon-comentarios'></div></div> <?php echo $lang[208]; ?></h3>
            </div>
            <div class="panel-body">
