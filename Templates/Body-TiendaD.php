      ...
      <div class="col-md-8">
         <div class="panel panel-default">
            ...
            <div class="panel-body">
               <?php
                  $query = $link->query("SELECT * FROM tiendadev  order by id DESC");
                  ...
                  <tbody>
                     <?php
                        while($row = mysqli_fetch_array($query)){
                          ...
                          $placa_code = $link->query("SELECT * FROM placasdev WHERE code = '".$code_placa."'");
                     ...
                     <tr>
                        ...
                        <td>
                           <form class="form-horizontal" action="tienda-dev.php" method="post" enctype="multipart/form-data"><input type="hidden" name="id_placa" value="<?php echo $row['id']; ?>"/><button type="submit" name="guardar" class="btn btn-primary"><?php echo $lang[46]; ?></button></form>
                        </td>
                     </tr>
                     <?php
                        }
               ...
               <?php
                  if (isset($_POST['guardar'])) {
                      ...
                      if($_SESSION["logeado"] == "SI"){
                          ...
                          $tienda = $link->query("SELECT * FROM tiendadev WHERE id = '".$_POST['id_placa']."'");
                          ...
                          $revisar = $link->query("SELECT * FROM usuarios_placasdev WHERE (username = '".$username."') AND (code_placa = '".$placa_code."')");
                  ...
                  $consulta = "UPDATE tiendadev SET unidades='$descuento_unidad' WHERE id ='".$_POST['id_placa']."'";
                  ...
                  $envio_placa = "INSERT INTO usuarios_placasdev (username,code_placa,img) values ('" . $usuario_activo . "','" . strip_tags($placa_code) . "','".$placa_img."')";
                  ...
                  $accion = "Ha comprado <b>($placa_code)</b> en la tienda dev.";
   ...
   <script>
      ...
      function load(page){
        ...
        $.ajax({
          ...
          url:'kernel/ajax/Body_TiendaD_ajax.php',
