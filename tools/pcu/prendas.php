...
<?php
    ...
    $stmt = $con->prepare("SELECT * FROM prendas WHERE Propietario = :usuario AND `Web` = '0'");
      ...
      <tbody>
         <tr bgcolor="#F0F0F0">
            <td align="left" style="border-top: 1px solid #FFFFFF;border-left: 1px solid #FFFFFF;">
               <strong><font size="2px">Prendas en el inventario</font></strong>
            </td>
         </tr>
         <tr>
            <td valign="middle" bgcolor="#FFFFFF" align="center" colspan="2">
               ...
               <div id="pest">
                  <br>
                  <table width="98%" cellspacing="1" cellpadding="6" border="0" bgcolor="#C7C7C7"
                     align="center">
                     <tbody>
                        <tr bgcolor="#F0F0F0">
                           <td align="left"
                              style="border-top: 1px solid #FFFFFF;border-left: 1px solid #FFFFFF;">
                              <strong><font size="2px">Prendas en el inventario</font></strong>
                           </td>
                        </tr>
                        <td valign="middle" bgcolor="#FFFFFF" align="center" colspan="2">
                           <font size="2px">No tienes prendas en el inventario.</font>
                        </td>
                        </tr>
                     </tbody>
                  </table>
...
<?php $stm = $con->prepare("SELECT * FROM prendas WHERE Propietario = :usuario AND `Web` = '1'");
$stm->bindParam(':usuario', $User, PDO::PARAM_STR);
$stm->execute();
...
<div id="pest">
   ...
   <table width="98%" cellspacing="1" cellpadding="6" border="0" bgcolor="#C7C7C7" align="center">
      <tbody>
         <tr bgcolor="#F0F0F0">
            <td align="left" style="border-top: 1px solid #FFFFFF;border-left: 1px solid #FFFFFF;">
               <strong><font size="2px"><font size="2px">Prendas guardadas</font></font></strong>
            </td>
         </tr>
         <tr>
            <td valign="middle" bgcolor="#FFFFFF" align="center" colspan="2">
                  ...
                  <table width="98%" cellspacing="1" cellpadding="6" border="0" bgcolor="#C7C7C7"
                     ...
                     <tbody>
                        <tr bgcolor="#F0F0F0">
                           <td align="left"
                              style="border-top: 1px solid #FFFFFF;border-left: 1px solid #FFFFFF;">
                              <strong><font size="2px">Prendas guardadas</font></strong>
                           </td>
                        </tr>
                        <td valign="middle" bgcolor="#FFFFFF" align="center" colspan="2">
                           <font size="2px">No tienes prendas guardadas en la web.</font>
                        </td>
                        </tr>
                     </tbody>
                  </table>
...
<?php
   ...
   function GetPrendaName($prenda)
   {
       ...
       else if ($prenda == 19801)
       {
           return "Mascara";
       }
       else if ($prenda == 18913)
       {
           return "Cubre boca";
       }
       else if ($prenda == 19472)
       {
           return "Mascara de gas";
       }
       else if ($prenda == 18897)
       {
           return "Bandana azul";
       }
       else if ($prenda == 18942)
       {
           return "Sombrero beige";
       }
       else if ($prenda == 18961)
       {
           return "Gorra camionero";
       }
       else if ($prenda == 19078)
       {
           return "Loro";
       }
       else if ($prenda == 18645)
       {
           return "Casco abierto";
       }
       else if ($prenda == 18976)
       {
           return "Casco Negro";
       }
       else if ($prenda == 18978)
       {
           return "Casco blanco";
       }
       else if ($prenda == 18979)
       {
           return "Casco morado";
       }
       else if ($prenda == 18949)
       {
           return "Sombrero verde";
       }
       else if ($prenda == 19136)
       {
           return "Sombrero y pelo";
       }
       else if ($prenda == 18962)
       {
           return "Sombrero negro";
       }
       else if ($prenda == 19352)
       {
           return "Sombrero elegante";
       }
       else if ($prenda == 18640)
       {
           return "Pelon";
       }
       else if ($prenda == 18893)
       {
           return "Gorra pirata blanca";
       }
       else if ($prenda == 18895)
       {
           return "Gorra pirata negra";
       }
       else if ($prenda == 18915)
       {
           return "Cubre boca morado";
       }
       else if ($prenda == 18920)
       {
           return "Cubre boca amarillo";
       }
       else if ($prenda == 19022)
       {
           return "Lentes negros";
       }
       else if ($prenda == 19023)
       {
           return "Lentes azules";
       }
       else if ($prenda == 19025)
       {
           return "Lentes morado";
       }
       else if ($prenda == 19029)
       {
           return "Lentes verdes";
       }
       else if ($prenda == 19064)
       {
           return "Gorra de papa noel";
       }
       else if ($prenda == 19069)
       {
           return "Gorra negra";
       }
       else
