        ...
        <div class="card-cont flex justify-center">
          ...
          <table class="table-main">
            ...
            <tbody>
                ...
                $stmt = $conn->prepare("SELECT * FROM usuarios_mensajes_privados ORDER BY fecha DESC LIMIT $comienza,$maximo");
                $stmt->execute();
                while ($rowEquipo = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ?>
                <tr>
                    <td class="table-data"><?=$rowEquipo['id'];?></td>
                    <td class="table-data"><?=$rowEquipo['user_enviado'];?></td>
                    <td class="table-data"><?=$rowEquipo['rango'];?></td>
                    <td class="table-data"><?=$rowEquipo['user_recibido'];?></td>
                    <td class="table-data"><?=$rowEquipo['asunto'];?></td>
                    <td class="table-data"><?=$rowEquipo['mensaje'];?></td>
