...
$lang = array(
	...
	231	=>	"You have entered the administration panel of",
	232	=>	"You left the Hk correctly.",
	...
	284 => "You are welcome",
	285 => "This is the administration panel of",
	286 => "Here you can Publish, Manage, Delete all dynamic content of the web whether Articles, Promos, Shop, Moderation, Events etc...",
	287 => "Remember that if you find an error on the web report it to an Administrator or Founder of the website.",
	288 => "If you have any question about the administration of the web you should ask the Founders or developers of the website, you should also bear in mind that you should not abuse the time of the attendees and others as this may affect your ability to be understood.",
	289 => "Official Fansite",
	290 => "This page is not affiliated with, endorsed, promoted or approved specifically by Sulake Corporation Oy or its Affiliates. According to the Habbo Fan Web Site Policy, this page may use trademarks and other intellectual property of Habbo.",

// Desde aquí empiezas a traducir...........
