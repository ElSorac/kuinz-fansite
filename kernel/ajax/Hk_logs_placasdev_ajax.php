<?php
   ...
   if($action == 'ajax'){
   	...
   	$count_query   = $link->query("SELECT count(*) AS numrows FROM usuarios_placasdev ");
   	...
   	$query = $link->query("SELECT * FROM usuarios_placasdev order by id DESC LIMIT $offset,$per_page");
...
<table class="table table-striped table-hover ">
   ...
   <tbody>
      ...
      <tr>
         ...
         <td><a href="eliminar/comprados-dev.php?id=<?php echo "$row[id]"; ?>"><button type="button" class="btn btn-sm btn-danger"><span class="MPicon-cross"></span></button></a></td>
      </tr>
      <?php
         }
